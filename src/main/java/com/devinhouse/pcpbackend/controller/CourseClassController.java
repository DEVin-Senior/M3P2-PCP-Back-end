...
public class CourseClassController {
    ...
    @PutMapping("allocation/{idClass}/{idWeek}/{idTeacher}")
    public ClassUpdateDto allocation(@PathVariable Long idClass, @PathVariable Long idWeek, @PathVariable Long idTeacher) {
        return classService.allocatteTeacher(idClass, idWeek, idTeacher);
    }
